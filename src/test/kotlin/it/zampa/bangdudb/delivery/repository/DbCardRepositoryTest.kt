...
class DbCardRepositoryTest : SpringTestParent() {
	...
	@BeforeEach
	fun setUp() {
		jdbcTemplate.update("INSERT INTO public.cards (id, attribute, band, banner_id, card_name, card_name_jp, character_name, event_id, is_birthday, is_event, is_gacha, is_promo, is_unavailable_gacha, pf, power, rarity, release_date, skill_dailylife_description, skill_dailylife_description_jp, skill_dailylife_name, skill_dailylife_name_jp, skill_session_description, skill_session_description_jp, skill_session_name, skill_session_name_jp, skill_session_type, src_base_hq, src_base_lq, src_idl_hq, src_idl_lq, tec, vi, src_avatar) VALUES ('124_0001', 'Cool', 'Fantôme Iris', null, '1', '1', 'FELIX', null, true, false, false, false, false, 2, 1, 4, '$jan1st', '1', '1', '1', '1', '1', '1', '1', '1', 'scorer', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1_lq.jpg', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2_lq.jpg', 3, 4, '');")
		jdbcTemplate.update("INSERT INTO public.cards (id, attribute, band, banner_id, card_name, card_name_jp, character_name, event_id, is_birthday, is_event, is_gacha, is_promo, is_unavailable_gacha, pf, power, rarity, release_date, skill_dailylife_description, skill_dailylife_description_jp, skill_dailylife_name, skill_dailylife_name_jp, skill_session_description, skill_session_description_jp, skill_session_name, skill_session_name_jp, skill_session_type, src_base_hq, src_base_lq, src_idl_hq, src_idl_lq, tec, vi, src_avatar) VALUES ('124_0002', 'Cool', 'Fantôme Iris', null, '1', '1', 'FELIX', null, true, false, false, false, false, 2, 1, 4, '$jan1st', '1', '1', '1', '1', '1', '1', '1', '1', 'scorer', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1_lq.jpg', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2_lq.jpg', 3, 4, '');")
		jdbcTemplate.update("INSERT INTO public.cards (id, attribute, band, banner_id, card_name, card_name_jp, character_name, event_id, is_birthday, is_event, is_gacha, is_promo, is_unavailable_gacha, pf, power, rarity, release_date, skill_dailylife_description, skill_dailylife_description_jp, skill_dailylife_name, skill_dailylife_name_jp, skill_session_description, skill_session_description_jp, skill_session_name, skill_session_name_jp, skill_session_type, src_base_hq, src_base_lq, src_idl_hq, src_idl_lq, tec, vi, src_avatar) VALUES ('124_0003', 'Cool', 'Argonavis', null, '1', '1', 'Ren', null, true, false, false, false, false, 2, 1, 4, '$jan1st', '1', '1', '1', '1', '1', '1', '1', '1', 'scorer', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1_lq.jpg', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2_lq.jpg', 3, 4, '');")
		jdbcTemplate.update("INSERT INTO public.cards (id, attribute, band, banner_id, card_name, card_name_jp, character_name, event_id, is_birthday, is_event, is_gacha, is_promo, is_unavailable_gacha, pf, power, rarity, release_date, skill_dailylife_description, skill_dailylife_description_jp, skill_dailylife_name, skill_dailylife_name_jp, skill_session_description, skill_session_description_jp, skill_session_name, skill_session_name_jp, skill_session_type, src_base_hq, src_base_lq, src_idl_hq, src_idl_lq, tec, vi, src_avatar) VALUES ('124_0004', 'Cool', 'Argonavis', null, '1', '1', 'Banri', null, true, false, false, false, false, 2, 1, 4, '$jan1st', '1', '1', '1', '1', '1', '1', '1', '1', 'scorer', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_1_lq.jpg', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2.png', 'https://bang-dudb-test.s3-eu-west-1.amazonaws.com/cards/Card_Pic_124_0002_2_lq.jpg', 3, 4, '');")
	}
	...
	@Test
	fun `most recent cards must be first`() {
		repository.save(CARD.copy(release_date = jan2nd))
		val cards: Paginated<CardSummary> = repository.findCardsPaginated(page = 0, resultsPerPage = 3)
		assertEquals(CARD.id, cards.summary.first().card_id)
	}

	@Test
	fun `when two cards are released the same day, the rarer is first`() {
		repository.save(CARD.copy(id = "053_0001", rarity = 3, release_date = jan2nd))
		repository.save(CARD.copy(id = "054_0001", rarity = 4, release_date = jan2nd))
		val cards: Paginated<CardSummary> = repository.findCardsPaginated(page = 0, resultsPerPage = 3)
		assertEquals("054_0001", cards.summary.first().card_id)
	}

	@Test
	fun `when release date and rarity is the same, order by characters`() {
		repository.save(CARD.copy(id = "024_0001", rarity = 4, release_date = jan2nd, character_name = "not important"))
		repository.save(CARD.copy(id = "014_0001", rarity = 4, release_date = jan2nd, character_name = "not important"))
		val cards: Paginated<CardSummary> = repository.findCardsPaginated(page = 0, resultsPerPage = 3)
		assertEquals("014_0001", cards.summary.first().card_id)
	}
